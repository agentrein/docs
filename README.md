...
To preview changes to the documentation on your machine:

1. Open this directory in your terminal: `cd docs`
2. Run the Mintlify dev server: `npx mintlify dev`
